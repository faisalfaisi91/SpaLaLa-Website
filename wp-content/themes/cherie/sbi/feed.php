...
$feed_classes    = SB_Instagram_Display_Elements::get_feed_container_css_classes( $settings, $additional_classes . ' art-sb_instagram' ); // already escaped
...
<div id="sb_instagram" <?php echo $feed_classes . $feed_styles; ?> data-feedid="<?php echo esc_attr( $feed_id ); ?>" <?php echo $feed_atts; ?> data-shortcode-atts="<?php echo esc_attr( $shortcode_atts ); ?>" <?php echo $other_atts; ?>>
    ...
    <div id="sbi_images" class="art-big-image" <?php echo $sb_images_style; ?>>
		<?php
		$i = 0;
