<?php
if ( ! function_exists( 'cherie_fontawesome_menu_icons' ) ) :
    function cherie_fontawesome_menu_icons() {
        $menu_font = array("disable",
            "fa fa-500px","fa fa-address-book","fa fa-address-book-o","fa fa-address-card","fa fa-address-card-o","fa fa-adjust","fa fa-adn","fa fa-align-center","fa fa-align-justify","fa fa-align-left","fa fa-align-right",
...
if (!class_exists('CHERIE_Mega_menu')) {
	class CHERIE_Mega_menu {
		...
		public static function options() {
            $icon_ListMenu = cherie_fontawesome_menu_icons();


			return array(
			    '_cherie_mega_menu_icon'	=> array(
                    'type'      => 'select_icon',
                    'label'     => esc_html__('Select Icon', 'cherie'),
                    'default'   => 0,
                    'options'   => $icon_ListMenu,
                    'size'      => 'wide',
                ),
				'_cherie_mega_menu_image'	=> array(
						'type' => 'upload',
						'label' => esc_html__('Image', 'cherie'),
						'default' => '',
						'size' => 'wide',
						'depth' => '0',  
						'class' => 'cherie-show-only-depth-0',
					),
				
				'_cherie_mega_menu_bg_position'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Background position', 'cherie' ),
						'default' => 0,
						'options' => array(
								'left top'              => esc_html__('Left top', 'cherie'),
								'left center'           => esc_html__('Left center', 'cherie'),
								'left bottom'           => esc_html__('Left bottom', 'cherie'),
								'right top'             => esc_html__('Right top', 'cherie'),
								'right center'          => esc_html__('Right center', 'cherie'),
								'right bottom'          => esc_html__('Right bottom', 'cherie'),
								'center top'            => esc_html__('Center top', 'cherie'),
								'center center'         => esc_html__('Center center', 'cherie'),
								'center bottom'         => esc_html__('Center bottom', 'cherie')
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'cherie-show-only-depth-0',
					),
				'_cherie_mega_menu_bg_repeat'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Background repeat', 'cherie' ),
						'default' => 'no-repeat',
						'options' => array(
								'no-repeat'         => esc_html__( 'No-repeat', 'cherie' ),
								'repeat'            => esc_html__( 'Repeat', 'cherie' ),
								'repeat-x'          => esc_html__( 'Repeat-x', 'cherie' ),
								'repeat-y'          => esc_html__( 'Repeat-y', 'cherie' ),
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'cherie-show-only-depth-0',
					),
				'_cherie_mega_menu_enabled'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Enable mega menu', 'cherie' ),
						'default' => 0,
						'options' => array(
						    1=> esc_html__( 'Yes', 'cherie' ),
                            0=> esc_html__( 'No', 'cherie' )),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'cherie-show-only-depth-0 cherie-mega-menu',
					),
				'_cherie_full_width_menu_enabled'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Enable full-width menu', 'cherie' ),
						'default' => 0,
						'options' => array(
						    1=> esc_html__( 'Yes', 'cherie' ),
                            0=> esc_html__( 'No', 'cherie' )),
				...
				'_cherie_mega_menu_limit_columns'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Limit Max columns number', 'cherie' ),
						'default' => 0,
						'options' => array(
								''	=>	esc_html__( 'None', 'cherie' ),
								1	=>	esc_html__( 'One columns', 'cherie' ),
								2	=>	esc_html__( 'Two columns', 'cherie' ),
								3	=>	esc_html__( 'Three columns', 'cherie' ),
                                4	=>	esc_html__( 'Four columns', 'cherie' ),
                                5	=>	esc_html__( 'Five columns', 'cherie' ),
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'cherie-show-only-depth-0 cherie-columns-limit',
					),
			);
		}
		...
		private function _add_filters() {
			...
			add_action('admin_enqueue_scripts', array( $this, 'cherie_mega_menu_admin_scripts' ), 80);
		}
		
		
 
		function cherie_mega_menu_admin_scripts() {
			wp_enqueue_media();
		}
		...
		public function apply_edit_walker_class( $walker, $menu_id ) {
			return CHERIE_EDIT_MENU_WALKER_CLASS;
		}
	}
}
