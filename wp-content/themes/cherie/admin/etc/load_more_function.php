<?php
function cherie_ajax_pagination($wp_query = null,$btn_position = 'left',$btn_style = 'primary') {
			...
			wp_localize_script(
                'ajax-pagination',
                'cherie_pagination_data',
                array(
                    'startPage'                 => $paged,
                    'maxPages'                  => $max_num_pages,
                    'nextLink'                  => next_posts($max_num_pages, false),
                    'button_text'               => cherie_get_theme_mod('load_more_text'),
                    'button_text_no_post'       => cherie_get_theme_mod('load_more_text_blog'),
                    'button_loading'            => cherie_get_theme_mod('load_more_loading_text'),
                    'button_text_no_portfolio'  => cherie_get_theme_mod('load_more_text_portfolio'),
			...
			wp_enqueue_script('ajax-pagination');
				echo '<div class="fl-pagination ajax-pagination '.$button_position.'">'
                    . '<span id="fl-ajax-load-more-pagination" class="fl-custom-btn fl-font-style-bolt-two '.$btn_html_class.'"><span>'.cherie_get_theme_mod('load_more_text').'</span></span>'
                    . '</div>';
		}