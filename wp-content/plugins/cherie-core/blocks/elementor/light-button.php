...
class Widget_Art_Light_button extends Widget_Base {

	public function get_name() {
		return 'art-light-button';
	}

	public function get_title() {
		return esc_html__( 'Light Button', 'mola_core' );
	}
        ...
        <?php switch ($all_settings['user_choice']):
            ...
            case 'gift_cart':
                ...
                if($all_settings['settings_second_gift_cart_title']):
                    ...
                    ?>
                    <div class="art-widget-button art--aliment-<?php echo $all_settings['content_align']; ?> art--aliment-tablet-<?php echo $all_settings['content_align_tablet']; ?> art--aliment-mobile-<?php echo $all_settings['content_align_mobile']; ?>">
                        <a href="<?php echo get_permalink( $product->ID ) ?>" class="art-button <?php echo $all_settings['button_style']; ?>"><?php echo $all_settings['button_text']; ?></a>
                    </div>
                <?php
                endif;
...
Plugin::instance()->widgets_manager->register( new Widget_Art_Light_button );
?>
