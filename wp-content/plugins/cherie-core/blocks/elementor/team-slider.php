...
class Widget_Woo_Team_Slider extends Widget_Base {

	public function get_name() {
		return 'woo-team-slider';
	}

	public function get_title() {
		return esc_html__( 'Team Slider', 'mola_core' );
	}
	...
	protected function render( $instance = [] ) {
		...
		<div class="art-widget-team-slider">

			<div class="swiper-team-container art-swiper-team-container">

				<div class="art-all-members swiper-wrapper">
					...
					<?php foreach ( $settings['list'] as $member ): ?>
						...
						<div class="swiper-slide">
                            ...
                            <div class="art-team-wrap">
                                ...
                                <a href="#art-team-member-popup-<?php echo $art_i; ?>" class="open-team-popup-link">
                                    <img src="<?php echo $member['member_image']['url']; ?>" alt="Team Member">
                                </a>

                                <a href="#art-team-member-popup-<?php echo $art_i; ?>" class="open-team-popup-link art-member-title">
                            ...
                            <div id="art-team-member-popup-<?php echo $art_i; ?>" class="zoom-anim-dialog art-team-popap mfp-hide">
...
Plugin::instance()->widgets_manager->register( new Widget_Woo_Team_Slider );
?>
