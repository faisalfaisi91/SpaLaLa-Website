...
class Widget_Art_Contact_Info extends Widget_Base
{

    public function get_name()
    {
        return 'art-contact-info';
    }

    public function get_title()
    {
        return __('Contact Info', 'cherie-core');
    }
...
Plugin::instance()->widgets_manager->register(new Widget_Art_Contact_Info);
?>
