...
class Widget_Woo_starshop_products extends Widget_Base {

	public function get_name() {
		return 'woo-star-products';
	}

	public function get_title() {
		return esc_html__( 'Woo Products', 'cherie-core' );
	}
	...
	public function show_my_products() {
		$show_my_products = array(
			'' => '',
			'featured' => esc_html__( 'Featured products', 'cherie-core' )
		);
	...
	public function get_orderby_products() {
		$orderby_products = array(
			'' => 'No order',
			'comment_count' => esc_html__( 'The most commented', 'cherie-core' ),
			'regular_price' => esc_html__( 'By regular price', 'cherie-core' ),
			'sale_price' => esc_html__( 'By sale price', 'cherie-core' ),
		);
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Products', 'cherie-core' ),
		...
		/*$this->add_control(
			'show_my_products',
			[
				'label' => esc_html__( 'Show', 'cherie-core' ),
		...
		$this->add_control(
			'orderby',
			[
				'label' => esc_html__( 'Order by', 'cherie-core' ),
				'type' => Controls_Manager::SELECT,
				'options' => $this->get_orderby_products(),
				'multiple' => false,
				'section' => 'section_art_products',
				'description' => esc_html__( 'Leave empty if you do not want to sort products.', 'cherie-core' ),
			]
		);
		...
		$this->add_control(
			'posts_count',
			[
				'label'   => esc_html__( 'Number of Products', 'cherie-core' ),
		...
		$this->add_control(
			'product_cols_width',
			[
				'label' => esc_html__( 'Columns number', 'cherie-core' ),
	...
	protected function render( $instance = [] ) {
        ...
        <div class="art-woo-products art-elementor-widget woocommerce">
            ...
            <ul class="products art-no-list-style">
				...
				if ( $product_cols_width ) {
					switch ( $product_cols_width ) {
						case 1 :
							$product_cols_width_class = 'col-12';
							break;
						case 2:
							$product_cols_width_class = 'col-md-6';
							break;
						case 3:
							$product_cols_width_class = 'col-sm-6 col-md-4';
							break;
						case 4:
							$product_cols_width_class = 'col-12 col-sm-6 col-md-4 col-lg-3';
							break;
						default:
							$product_cols_width_class = '';
					}
				...
				foreach ( $posts as $post ) { setup_postdata( $post ); ?>
                    ...
                    <li class="product <?php esc_attr_e( $product_cols_width_class ); ?>">
						<?php
						/**
...
Plugin::instance()->widgets_manager->register( new Widget_Woo_starshop_products );
?>
