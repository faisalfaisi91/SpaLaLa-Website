...
class Widget_Art_Half_Slider_Right extends Widget_Base {

	public function get_name() {
		return 'art-half-slider-right';
	}

	public function get_title() {
		return esc_html__( 'Half Slider Right', 'mola_core' );
	}
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'left_side_button',
            [
                'label' => esc_html__( 'Left Side Button', 'mola_core' ),
	...
	protected function render() {
        ...
        <div class="art-right-half-slider-wrapper">
            ...
            <div class="art-half-slide-container-right <?php echo $all_settings['slider_class']; ?>">
...
Plugin::instance()->widgets_manager->register( new Widget_Art_Half_Slider_Right );
?>
